...
```
Troubleshooting Tip: If there are errors in your R package DESCRIPTION file, usethis::use_vignette() will not run.  If you encounter this error, use load_all() to see details of where the error exists and resolve, then try running again.  
